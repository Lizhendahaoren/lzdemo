...
import com.ch.lz.base.security.MyUserDetails;
...
public class XaUtil {
	 ...
	 * 获取当前时间.
	 * 
	 * @param currentDate the current date @return @throws
	 */
	...
	public static String getCmsLoginedUserName() {
		...
		} else if (userDetails instanceof MyUserDetails) {
			userName = ((MyUserDetails) userDetails).getUsername();
		}
		return userName;
	}
